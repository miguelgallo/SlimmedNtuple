...
if MC:
  process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
      "root://cms-xrd-global.cern.ch//store/mc/RunIISummer20UL18MiniAOD/ST_t-channel_top_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8/MINIAODSIM/106X_upgrade2018_realistic_v11_L1v1-v1/2530000/52A506F4-FAAF-2B46-8C11-B3F5D7967D83.root"
      ...
      #"file:/eos/cms/store/group/phys_pps/MC/requests_2017mcv2/private/WW_bSM/MINIAOD/FPMC_WW_bSM_13tev_a0w_0_aCw_2e-5_semi_pt0/FPMC_WW_bSM_13tev_a0w_0_aCw_2e-5_semi_pt0_MINIAOD_78.root"
    )
  )
...
if DATA and Run2_2017:
  process.source = cms.Source("PoolSource",
      fileNames = cms.untracked.vstring(
        ...
        #'root://cms-xrd-global.cern.ch//store/data/Run2017B/SingleElectron/MINIAOD/31Mar2018-v1/60000/AEACB32F-F537-E811-8516-008CFAC93E78.root'
...
process.load("SlimmedNtuple.Ntupler.CfiFile_cfi_crab")
...
if MC:
  ...
  # double-check values 2017 or 2018
  ...
  # double-check betaStar 2017 and 2018
...
process.slimmedJetsAK8JetId = cms.EDFilter("PFJetIDSelectionFunctorFilter",
                                           ...
                                           src = cms.InputTag(COLLECTIONFORIDAK8),       #MC
                                           #src = cms.InputTag("selectedPatJetsAK8PFCHS"), #DATA
