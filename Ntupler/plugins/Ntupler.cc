...
Ntupler::Ntupler(const edm::ParameterSet& iConfig):
  ...
  pps_token_(consumes<std::vector<CTPPSLocalTrackLite>>(edm::InputTag(("ppsLocalTrackTag")))),
  */
  ...
  hltPrescaleProvider_(iConfig, consumesCollector(), *this)
{
  ...
  if(isMC == true)
    {
      ...
      if(year==2017){
	LumiWeights = new edm::LumiReWeighting("PUHistos_mc_2017_UL.root", "PUHistos_data_2017.root", "pileup", "pileup");}
      if(year==2018){
	LumiWeights = new edm::LumiReWeighting("PUHistos_mc_2018_UL.root", "PUHistos_data_2018.root","pileup", "pileup");}
  ...
  if (isInteractive==true){
    if(year==2017){
      prefix="/afs/cern.ch/user/m/malvesga/work/ProtonRecon/TEST/CMSSW_10_6_30/src/SlimmedNtuple/Ntupler/python/2017-JEC-JER/";}
    if(year==2018){
      prefix="/afs/cern.ch/user/m/malvesga/work/ProtonRecon/TEST/CMSSW_10_6_30/src/SlimmedNtuple/Ntupler/python/2018-JEC-JER/";}
  }
  else{
    prefix="";
  }
  ...
  if(isMC==false && year==2017 && era == "B")
    {
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunB_V5_DATA_L2Relative_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunB_V5_DATA_L3Absolute_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunB_V5_DATA_L2L3Residual_AK8PFchs.txt");
    }
  if(isMC==false && year==2017 && era == "C")
    {
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunC_V5_DATA_L2Relative_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunC_V5_DATA_L3Absolute_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunC_V5_DATA_L2L3Residual_AK8PFchs.txt");

    }
  if(isMC==false && year==2017 && era == "D")
    {
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunD_V5_DATA_L2Relative_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunD_V5_DATA_L3Absolute_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunD_V5_DATA_L2L3Residual_AK8PFchs.txt");
    }
  if(isMC==false && year==2017 && era == "E")
    {
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunE_V5_DATA_L2Relative_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunE_V5_DATA_L3Absolute_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunE_V5_DATA_L2L3Residual_AK8PFchs.txt");
    }
  if(isMC==false && year==2017 && era == "F")
    {
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunF_V5_DATA_L2Relative_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunF_V5_DATA_L3Absolute_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_RunF_V5_DATA_L2L3Residual_AK8PFchs.txt");
    }
  
  if(isMC==true && year==2017)
    {
       jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_V5_MC_L2Relative_AK8PFchs.txt");
       jecAK8PayloadNames_.push_back(prefix+"Summer19UL17_V5_MC_L3Absolute_AK8PFchs.txt");
  ...
  if(isMC==true && year==2018)
    {
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_V5_MC_L2Relative_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_V5_MC_L3Absolute_AK8PFchs.txt");
    }
  if(isMC==false && year==2018 && era == "A")
    {
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunA_V5_DATA_L2Relative_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunA_V5_DATA_L3Absolute_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunA_V5_DATA_L2L3Residual_AK8PFchs.txt");
    }
  if(isMC==false && year==2018 && era == "B")
    {
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunB_V5_DATA_L2Relative_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunB_V5_DATA_L3Absolute_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunB_V5_DATA_L2L3Residual_AK8PFchs.txt");
    }
  if(isMC==false && year==2018 && era == "C")
    {
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunC_V5_DATA_L2Relative_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunC_V5_DATA_L3Absolute_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunC_V5_DATA_L2L3Residual_AK8PFchs.txt");
    }
  if(isMC==false && year==2018 && era == "D")
    {
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunD_V5_DATA_L2Relative_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunD_V5_DATA_L3Absolute_AK8PFchs.txt");
      jecAK8PayloadNames_.push_back(prefix+"Summer19UL18_RunD_V5_DATA_L2L3Residual_AK8PFchs.txt");
    }
  /*
  ...
  */
   ...
   if(isMC==true && year==2017) // Note - here we're using Summer16 for 2017 MC, until the 2017 version is ready
     {                                     
       ...
       jerAK8chsName_res_ = prefix+"Summer19UL17_JRV2_MC_PtResolution_AK8PFchs.txt";
       jerAK8chsName_sf_ = prefix+"Summer19UL17_JRV2_MC_SF_AK8PFchs.txt";

       jerAK4chsName_res_ = prefix+"Summer19UL17_JRV2_MC_PtResolution_AK4PFchs.txt";
       jerAK4chsName_sf_ = prefix+"Summer19UL17_JRV2_MC_SF_AK4PFchs.txt";
   ...
   if(isMC==true && year==2018)
     {
       jerAK8chsName_res_ = prefix+"Summer19UL18_JRV2_MC_PtResolution_AK8PFchs.txt";
       jerAK8chsName_sf_ = prefix+"Summer19UL18_JRV2_MC_SF_AK8PFchs.txt";

       jerAK4chsName_res_ = prefix+"Summer19UL18_JRV2_MC_PtResolution_AK4PFchs.txt";
       jerAK4chsName_sf_ = prefix+"Summer19UL18_JRV2_MC_SF_AK4PFchs.txt";
...
Ntupler::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  *lumiblock_ = iEvent.luminosityBlock();
  ...
  random = new TRandom3(); 
  rc = new RoccoR();
  std::string prefix_roc;
  if (isInteractive==true){
    prefix_roc="/afs/cern.ch/user/m/malvesga/work/ProtonRecon/TEST/CMSSW_10_6_30/src/Roccor/";
  }
  else{
    prefix_roc="";
  }
  if(year==2017) rc->init(prefix_roc+"RoccoR2017UL.txt");
  if(year==2018) rc->init(prefix_roc+"RoccoR2018UL.txt");
    ...
    if(tightId&&MuonIt.pt()>35&&fabs(MuonIt.eta())<2.4&&iso<0.1){
      ...
      if(isMC==true){
         ...
         for (reco::GenParticleCollection::const_iterator mcIter=genP->begin(); mcIter != genP->end(); mcIter++ ) {
            if((fabs(mcIter->pdgId()) == 13) && (mcIter->status() == 1)) {
               float dr = deltaR2(MuonIt.eta(), MuonIt.phi(), mcIter->eta(), mcIter->phi());
               if (dr < 0.1 && dr < bestdr) {
                  bestmatch_pt = mcIter->pt();
                  bestdr = dr;
               }
            }
         }
      ...
      if (isMC==true) {
         if (bestmatch_pt>0) {
            muSF = rc->kSpreadMC(MuonIt.charge(), MuonIt.pt(), MuonIt.eta(), MuonIt.phi(), bestmatch_pt);
            deltamuSF = rc->kSpreadMCerror(MuonIt.charge(), MuonIt.pt(), MuonIt.eta(), MuonIt.phi(), bestmatch_pt);
         } else {
            if(MuonIt.innerTrack().isNonnull()) {
               muSF = rc->kSmearMC(MuonIt.charge(), MuonIt.pt(), MuonIt.eta(), MuonIt.phi(), n_tracker_layers, random->Rndm());
               deltamuSF = rc->kSmearMCerror(MuonIt.charge(), MuonIt.pt(), MuonIt.eta(), MuonIt.phi(), n_tracker_layers, random->Rndm());
            }
         }
      } else {
         muSF = rc->kScaleDT(MuonIt.charge(), MuonIt.pt(), MuonIt.eta(), MuonIt.phi());
         deltamuSF = rc->kScaleDTerror(MuonIt.charge(), MuonIt.pt(), MuonIt.eta(), MuonIt.phi());
      }

      (*muon_Roccor_).push_back(muSF);
      (*muon_deltaRoccor_).push_back(deltamuSF);
      (*muon_px_).push_back(MuonIt.px()*muSF);
      (*muon_py_).push_back(MuonIt.py()*muSF);
      (*muon_pz_).push_back(MuonIt.pz()*muSF);
      (*muon_e_).push_back(MuonIt.energy()*muSF);
      (*muon_charge_).push_back(MuonIt.charge());
      (*muon_pt_).push_back(MuonIt.pt()*muSF);
  ...
  (*prefiring_weight_ECAL_).push_back(_prefiringweightECAL);
  (*prefiring_weight_ECAL_up_).push_back(_prefiringweightECALup);
  (*prefiring_weight_ECAL_down_).push_back(_prefiringweightECALdown);
  (*prefiring_weight_Muon_).push_back(_prefiringweightMuon);
  (*prefiring_weight_Muon_up_).push_back(_prefiringweightMuonup);
  (*prefiring_weight_Muon_down_).push_back(_prefiringweightMuondown);
   ...
   */
   ...
   for(unsigned int i = 0; i < n; ++i) {
     ...
     double var_energyScaleValue = (*electronHandle)[i].userFloat("energyScaleValue");
     ...
     double var_energySigmaValue = (*electronHandle)[i].userFloat("energySigmaValue");
     ...
     if(isPassEleId&&el->pt()>40&&fabs(el->superCluster()->eta())<2.4){ 
       ...
       (*electron_energyScaleValue_).push_back(var_energyScaleValue);
       (*electron_energyScaleUp_).push_back(var_energyScaleUp);
       (*electron_energyScaleDown_).push_back(var_energyScaleDown);
       (*electron_energySigmaValue_).push_back(var_energySigmaValue);
   ...
   *met_pxJER_Up_ = MET->corPx()*(*met_ptJER_Up_)/MET->corPt();
   *met_pyJER_Up_ = MET->corPy()*(*met_ptJER_Up_)/MET->corPt();
   *met_ptJER_Down_ = MET->shiftedPt(pat::MET::JetResDown);
   *met_pxJER_Down_ = MET->corPx()*(*met_ptJER_Down_)/MET->corPt();
   *met_pyJER_Down_ = MET->corPy()*(*met_ptJER_Down_)/MET->corPt();
   ...
   *met_pxJES_Up_ = MET->corPx()*(*met_ptJES_Up_)/MET->corPt();;
   *met_pyJES_Up_ = MET->corPy()*(*met_ptJES_Up_)/MET->corPt();;
   *met_ptJES_Down_ = MET->shiftedPt(pat::MET::JetEnDown);
   *met_pxJES_Down_ = MET->corPx()*(*met_ptJES_Down_)/MET->corPt();;
   *met_pyJES_Down_ = MET->corPy()*(*met_ptJES_Down_)/MET->corPt();;
   ...
   */
   ...
   if(passFatJet){
     ...
     *pfcand_nextracks_noDRl_=count_pv_noDRl;
     ...
     TLorentzVector LeptonP4_corr_up;
     TLorentzVector LeptonP4_corr_dw;
     if(passes_muon||passes_dimuon){
     ...
     //
     //Neutrino 
     TLorentzVector SecondLeptonP4, SecondLeptonP4_metJER_Up, SecondLeptonP4_metJER_Down, SecondLeptonP4_metJES_Up, SecondLeptonP4_metJES_Down;
     if(passes_muon||passes_electron){
       TLorentzVector Neutrino_nominal = Nu4Momentum(LeptonP4, METPt, METphi);   // Neutrino Method   
       TLorentzVector Neutrino_metJER_Up = Nu4Momentum(LeptonP4, *met_ptJER_Up_, *met_phiJER_Up_);   // Neutrino Method   
       TLorentzVector Neutrino_metJER_Down = Nu4Momentum(LeptonP4, *met_ptJER_Down_, *met_phiJER_Down_);   // Neutrino Method   
       TLorentzVector Neutrino_metJES_Up = Nu4Momentum(LeptonP4, *met_ptJES_Up_, *met_phiJES_Up_);   // Neutrino Method   
       TLorentzVector Neutrino_metJES_Down = Nu4Momentum(LeptonP4, *met_ptJES_Down_, *met_phiJES_Down_);   // Neutrino Method   
       //double E_nu=sqrt(MET->corPx()*MET->corPx()+MET->corPy()*MET->corPy()+Neutrino_nominal.Pz()*Neutrino_nominal.Pz());
       double E_nu=sqrt( METPt*METPt + Neutrino_nominal.Pz()*Neutrino_nominal.Pz());
       double E_nu_metJER_Up=sqrt( ((*met_ptJER_Up_))*(*met_ptJER_Up_) + Neutrino_metJER_Up.Pz()*Neutrino_metJER_Up.Pz());
       double E_nu_metJER_Down=sqrt((*met_ptJER_Down_)*(*met_ptJER_Down_) + Neutrino_metJER_Down.Pz()*Neutrino_metJER_Down.Pz());
       double E_nu_metJES_Up=sqrt( ((*met_ptJES_Up_))*(*met_ptJES_Up_) + Neutrino_metJES_Up.Pz()*Neutrino_metJES_Up.Pz());
       double E_nu_metJES_Down=sqrt((*met_ptJES_Down_)*(*met_ptJES_Down_) + Neutrino_metJES_Down.Pz()*Neutrino_metJES_Down.Pz());
       SecondLeptonP4 = TLorentzVector(*met_x_,*met_y_,Neutrino_nominal.Pz(),E_nu); 
       SecondLeptonP4_metJER_Up = TLorentzVector(*met_pxJER_Up_,*met_pyJER_Up_,Neutrino_metJER_Up.Pz(),E_nu_metJER_Up); 
       SecondLeptonP4_metJER_Down = TLorentzVector(*met_pxJER_Down_,*met_pyJER_Down_,Neutrino_metJER_Down.Pz(),E_nu_metJER_Down); 
       SecondLeptonP4_metJES_Up = TLorentzVector(*met_pxJES_Up_,*met_pyJES_Up_,Neutrino_metJES_Up.Pz(),E_nu_metJES_Up); 
       SecondLeptonP4_metJES_Down = TLorentzVector(*met_pxJES_Down_,*met_pyJES_Down_,Neutrino_metJES_Down.Pz(),E_nu_metJES_Down); 
     }
     if(passes_dimuon){
     ...
     TLorentzVector WLeptonic_metJER_Up = LeptonP4 + SecondLeptonP4_metJER_Up;
     TLorentzVector WLeptonic_metJER_Down = LeptonP4 + SecondLeptonP4_metJER_Down;
     TLorentzVector WLeptonic_metJES_Up = LeptonP4 + SecondLeptonP4_metJES_Up;
     TLorentzVector WLeptonic_metJES_Down = LeptonP4 + SecondLeptonP4_metJES_Down;
     double WLeptonic_Pt  = WLeptonic.Pt();
     double WLeptonic_Pt_metJER_Up  = WLeptonic_metJER_Up.Pt();
     double WLeptonic_Pt_metJER_Down  = WLeptonic_metJER_Down.Pt();
     double WLeptonic_Pt_metJES_Up  = WLeptonic_metJES_Up.Pt();
     double WLeptonic_Pt_metJES_Down  = WLeptonic_metJES_Down.Pt();
     double WLeptonic_M   = WLeptonic.M();
     double WLeptonic_M_metJER_Up   = WLeptonic_metJER_Up.M();
     double WLeptonic_M_metJER_Down   = WLeptonic_metJER_Down.M();
     double WLeptonic_M_metJES_Up   = WLeptonic_metJES_Up.M();
     double WLeptonic_M_metJES_Down   = WLeptonic_metJES_Down.M();
     ...
     TLorentzVector WW_p4_nu_metJER_Up  = WLeptonic_metJER_Up + p4SumJets;               // Wlep with Nu
     TLorentzVector WW_p4_nu_metJER_Down  = WLeptonic_metJER_Down + p4SumJets;               // Wlep with Nu
     TLorentzVector WW_p4_nu_metJES_Up  = WLeptonic_metJES_Up + p4SumJets;               // Wlep with Nu
     TLorentzVector WW_p4_nu_metJES_Down  = WLeptonic_metJES_Down + p4SumJets;               // Wlep with Nu
     double MWW_Nu  = WW_p4_nu.M();
     double MWW_Nu_metJER_Up  = WW_p4_nu_metJER_Up.M();
     double MWW_Nu_metJER_Down  = WW_p4_nu_metJER_Down.M();
     double MWW_Nu_metJES_Up  = WW_p4_nu_metJES_Up.M();
     double MWW_Nu_metJES_Down  = WW_p4_nu_metJES_Down.M();
     *recoMWhad_=WJM;

     *recoMWlep_=WLeptonic_M;
     *recoMWlep_metJER_Up_=WLeptonic_M_metJER_Up;
     *recoMWlep_metJER_Down_=WLeptonic_M_metJER_Down;
     *recoMWlep_metJES_Up_=WLeptonic_M_metJES_Up;
     *recoMWlep_metJES_Down_=WLeptonic_M_metJES_Down;
     double dphi=deltaPhi(WLeptonic_phi,WJphi);
     *dphiWW_=dphi;
     *WLeptonicPhi_=WLeptonic_phi;
     *WLeptonicPt_=WLeptonic_Pt;
     *WLeptonicPt_metJER_Up_=WLeptonic_Pt_metJER_Up;
     *WLeptonicPt_metJER_Down_=WLeptonic_Pt_metJER_Down;
     *WLeptonicPt_metJES_Up_=WLeptonic_Pt_metJES_Up;
     *WLeptonicPt_metJES_Down_=WLeptonic_Pt_metJES_Down;
     *WLeptonicEta_=WLeptonic.Rapidity();
     *recoMWW_=MWW_Nu;
     *recoMWW_metJER_Up_=MWW_Nu_metJER_Up;
     *recoMWW_metJER_Down_=MWW_Nu_metJER_Down;
     *recoMWW_metJES_Up_=MWW_Nu_metJES_Up;
     *recoMWW_metJES_Down_=MWW_Nu_metJES_Down;
     *recoWWpt_=WW_p4_nu.Pt();
     *recoWWpt_metJER_Up_=WW_p4_nu_metJER_Up.Pt();
     *recoWWpt_metJER_Down_=WW_p4_nu_metJER_Down.Pt();
     *recoWWpt_metJES_Up_=WW_p4_nu_metJES_Up.Pt();
     *recoWWpt_metJES_Down_=WW_p4_nu_metJES_Down.Pt();
   ...
   (*muon_Roccor_).clear();
   (*muon_deltaRoccor_).clear();

   (*prefiring_weight_).clear();
   (*prefiring_weight_up_).clear();
   (*prefiring_weight_down_).clear();
   (*prefiring_weight_ECAL_).clear();
   (*prefiring_weight_ECAL_up_).clear();
   (*prefiring_weight_ECAL_down_).clear();
   (*prefiring_weight_Muon_).clear();
   (*prefiring_weight_Muon_up_).clear();
   (*prefiring_weight_Muon_down_).clear();
   ...
   (*electron_energyScaleValue_).clear();
   (*electron_energyScaleUp_).clear();
   (*electron_energyScaleDown_).clear();
   (*electron_energySigmaValue_).clear();
...
Ntupler::beginJob()
{
  ...
  muon_Roccor_ = new std::vector<float>;
  muon_deltaRoccor_ = new std::vector<float>;
  ...
  prefiring_weight_ECAL_ = new std::vector<float>;
  prefiring_weight_ECAL_up_ = new std::vector<float>;
  prefiring_weight_ECAL_down_ = new std::vector<float>;
  prefiring_weight_Muon_ = new std::vector<float>;
  prefiring_weight_Muon_up_ = new std::vector<float>;
  prefiring_weight_Muon_down_ = new std::vector<float>;
  ...
  electron_energyScaleValue_ = new std::vector<float>;
  electron_energyScaleUp_ = new std::vector<float>;
  electron_energyScaleDown_ = new std::vector<float>;
  electron_energySigmaValue_ = new std::vector<float>;
  ...
  met_pxJER_Up_ = new float;
  met_pyJER_Up_ = new float;
  met_ptJER_Down_ = new float;
  met_pxJER_Down_ = new float;
  met_pyJER_Down_ = new float;
  met_phiJER_Up_ = new float;
  met_phiJER_Down_ = new float;
  met_ptJES_Up_ = new float;
  met_pxJES_Up_ = new float;
  met_pyJES_Up_ = new float;
  met_ptJES_Down_ = new float;
  met_pxJES_Down_ = new float;
  met_pyJES_Down_ = new float;
  ...
  recoMWlep_metJER_Up_ = new float;
  recoMWlep_metJER_Down_ = new float;
  recoMWlep_metJES_Up_ = new float;
  recoMWlep_metJES_Down_ = new float;
  recoMWW_ = new float;  
  recoMWW_metJER_Up_ = new float;  
  recoMWW_metJER_Down_ = new float;  
  recoMWW_metJES_Up_ = new float;  
  recoMWW_metJES_Down_ = new float;  
  recoWWpt_ = new float;
  recoWWpt_metJER_Up_ = new float;
  recoWWpt_metJER_Down_ = new float;
  recoWWpt_metJES_Up_ = new float;
  recoWWpt_metJES_Down_ = new float;
  genWWpt_ = new float;
  recoRapidityWW_ = new float;
  dphiWW_ = new float;
  WLeptonicPt_ = new float;
  WLeptonicPt_metJER_Up_ = new float;
  WLeptonicPt_metJER_Down_ = new float;
  WLeptonicPt_metJES_Up_ = new float;
  WLeptonicPt_metJES_Down_ = new float;
  ...
  tree_->Branch("muon_Roccor",&muon_Roccor_);
  tree_->Branch("muon_deltaRoccor",&muon_deltaRoccor_);
  ...
  tree_->Branch("prefiring_weight_ECAL",&prefiring_weight_ECAL_);
  tree_->Branch("prefiring_weight_ECAL_up",&prefiring_weight_ECAL_up_);
  tree_->Branch("prefiring_weight_ECAL_down",&prefiring_weight_ECAL_down_);
  tree_->Branch("prefiring_weight_Muon",&prefiring_weight_Muon_);
  tree_->Branch("prefiring_weight_Muon_up",&prefiring_weight_Muon_up_);
  tree_->Branch("prefiring_weight_Muon_down",&prefiring_weight_Muon_down_);
  ...
  tree_->Branch("electron_energyScaleValue",&electron_energyScaleValue_);
  ...
  tree_->Branch("electron_energySigmaValue",&electron_energySigmaValue_);
  ...
  tree_->Branch("met_pxJER_Up",met_pxJER_Up_,"met_pxJER_Up/f");
  tree_->Branch("met_pyJER_Up",met_pyJER_Up_,"met_pyJER_Up/f");
  tree_->Branch("met_ptJER_Down",met_ptJER_Down_,"met_ptJER_Down/f");
  tree_->Branch("met_pxJER_Down",met_pxJER_Down_,"met_pxJER_Down/f");
  tree_->Branch("met_pyJER_Down",met_pyJER_Down_,"met_pyJER_Down/f");
  ...
  tree_->Branch("met_pxJES_Up",met_pxJES_Up_,"met_pxJES_Up/f");
  tree_->Branch("met_pyJES_Up",met_pyJES_Up_,"met_pyJES_Up/f");
  tree_->Branch("met_ptJES_Down",met_ptJES_Down_,"met_ptJES_Down/f");
  tree_->Branch("met_pxJES_Down",met_pxJES_Down_,"met_pxJES_Down/f");
  tree_->Branch("met_pyJES_Down",met_pyJES_Down_,"met_pyJES_Down/f");
  ...
  tree_->Branch("recoMWlep_metJER_Up",recoMWlep_metJER_Up_,"recoMWlep_metJER_Up/f");
  tree_->Branch("recoMWlep_metJER_Down",recoMWlep_metJER_Down_,"recoMWlep_metJER_Down/f");
  tree_->Branch("recoMWlep_metJES_Up",recoMWlep_metJES_Up_,"recoMWlep_metJES_Up/f");
  tree_->Branch("recoMWlep_metJES_Down",recoMWlep_metJES_Down_,"recoMWlep_metJES_Down/f");
  tree_->Branch("recoMWW",recoMWW_,"recoMWW/f");
  tree_->Branch("recoMWW_metJER_Up",recoMWW_metJER_Up_,"recoMWW_metJER_Up/f");
  tree_->Branch("recoMWW_metJER_Down",recoMWW_metJER_Down_,"recoMWW_metJER_Down/f");
  tree_->Branch("recoMWW_metJES_Up",recoMWW_metJES_Up_,"recoMWW_metJES_Up/f");
  tree_->Branch("recoMWW_metJES_Down",recoMWW_metJES_Down_,"recoMWW_metJES_Down/f");
  tree_->Branch("recoRapidityWW",recoRapidityWW_,"recoRapidityWW/f");
  tree_->Branch("recoWWpt",recoWWpt_,"recoWWpt/f");
  tree_->Branch("recoWWpt_metJER_Up",recoWWpt_metJER_Up_,"recoWWpt_metJER_Up/f");
  tree_->Branch("recoWWpt_metJER_Down",recoWWpt_metJER_Down_,"recoWWpt_metJER_Down/f");
  tree_->Branch("recoWWpt_metJES_Up",recoWWpt_metJES_Up_,"recoWWpt_metJES_Up/f");
  tree_->Branch("recoWWpt_metJES_Down",recoWWpt_metJES_Down_,"recoWWpt_metJES_Down/f");
  tree_->Branch("genWWpt",genWWpt_,"genWWpt/f");
  tree_->Branch("dphiWW",dphiWW_,"dphiWW/f");
  tree_->Branch("WLeptonicPt",WLeptonicPt_,"WLeptonicPt/f");
  tree_->Branch("WLeptonicPt_metJER_Up",WLeptonicPt_metJER_Up_,"WLeptonicPt_metJER_Up/f");
  tree_->Branch("WLeptonicPt_metJER_Down",WLeptonicPt_metJER_Down_,"WLeptonicPt_metJER_Down/f");
  tree_->Branch("WLeptonicPt_metJES_Up",WLeptonicPt_metJES_Up_,"WLeptonicPt_metJES_Up/f");
  tree_->Branch("WLeptonicPt_metJES_Down",WLeptonicPt_metJES_Down_,"WLeptonicPt_metJES_Down/f");
...
Ntupler::endJob() 
{
  ...
  delete muon_Roccor_;
  delete muon_deltaRoccor_;

  delete prefiring_weight_;
  delete prefiring_weight_up_;
  delete prefiring_weight_down_;
  delete prefiring_weight_ECAL_;
  delete prefiring_weight_ECAL_up_;
  delete prefiring_weight_ECAL_down_;
  delete prefiring_weight_Muon_;
  delete prefiring_weight_Muon_up_;
  delete prefiring_weight_Muon_down_;
  ...
  delete electron_energyScaleValue_;
  delete electron_energyScaleUp_;
  delete electron_energyScaleDown_;
  delete electron_energySigmaValue_;
  ...
  delete met_pxJER_Up_;
  delete met_pyJER_Up_;
  delete met_ptJER_Down_;
  delete met_pxJER_Down_;
  delete met_pyJER_Down_;
  delete met_phiJER_Up_;
  delete met_phiJER_Down_;
  delete met_ptJES_Up_;
  delete met_pxJES_Up_;
  delete met_pyJES_Up_;
  delete met_ptJES_Down_;
  delete met_pxJES_Down_;
  delete met_pyJES_Down_;
  ...
  delete recoMWhad_;
  delete recoMWlep_;
  delete recoMWlep_metJER_Up_;
  delete recoMWlep_metJER_Down_;
  delete recoMWlep_metJES_Up_;
  delete recoMWlep_metJES_Down_;
  delete dphiWW_;
  delete recoMWW_;
  delete recoMWW_metJER_Up_;
  delete recoMWW_metJER_Down_;
  delete recoMWW_metJES_Up_;
  delete recoMWW_metJES_Down_;
  delete recoRapidityWW_;
  delete recoWWpt_;
  delete recoWWpt_metJER_Up_;
  delete recoWWpt_metJER_Down_;
  delete recoWWpt_metJES_Up_;
  delete recoWWpt_metJES_Down_;
  delete genWWpt_;
  delete WLeptonicPt_;
  delete WLeptonicPt_metJER_Up_;
  delete WLeptonicPt_metJER_Down_;
  delete WLeptonicPt_metJES_Up_;
  delete WLeptonicPt_metJES_Down_;
