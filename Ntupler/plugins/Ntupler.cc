...
Ntupler::Ntupler(const edm::ParameterSet& iConfig):
  ...
  recoProtonsSingleRPToken_   ( consumes<std::vector<reco::ForwardProton> >      (edm::InputTag("ppsRecoProtonSingleRPTag" ) ) ),
  recoProtonsMultiRPToken_ ( consumes<std::vector<reco::ForwardProton> > ( edm::InputTag("ppsRecoProtonMultiRPTag" ) ) ),
  */
